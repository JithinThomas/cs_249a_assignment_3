...
time ./client-manual-network-sim 1418385 360 1 1 1 > manual_1_1_1.txt
...
time ./client-manual-network-sim 1418385 360 1 0 1 > manual_1_0_1.txt

# Manual network simulation with constant distribution for trip interval and count and network modifications disabled
time ./client-manual-network-sim 1418385 360 0 1 1 > manual_0_1_1.txt
...
time ./client-manual-network-sim 1418385 360 0 0 1 > manual_0_0_1.txt

# Very dense network with network modification activity enabled
time ./client-auto-network-sim 400 80000 200 1 23901846 240 1 > very_dense_nm_1_cache_1.txt
time ./client-auto-network-sim 400 80000 200 1 23901846 240 0 > very_dense_nm_1_cache_0.txt
